...
+ (PlusAnimate *)standardPublishAnimateWithView:(UIView *)view{
    ...
    //Add button
    [animateView CrentBtnImageName:@"post_animate_camera" Title:@"代约私教" tag:0];
    [animateView CrentBtnImageName:@"post_animate_album" Title:@"设置排期" tag:1];
    [animateView CrentBtnImageName:@"post_animate_akey" Title:@"新增休息" tag:2];
    //Add center button
